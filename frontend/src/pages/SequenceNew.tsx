    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="bg-card border-b border-border sticky top-0 z-40">
        <div className="max-w-3xl mx-auto px-6 py-4">
          ...
          <h1 className="text-2xl font-semibold text-foreground">{t('sequences.create_new')}</h1>
          <p className="text-muted-foreground text-sm mt-1">{t('sequences.create_description')}</p>
        </div>
      </header>
        ...
        <form onSubmit={handleSubmit} className="bg-card rounded-2xl border border-border p-6 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="w-full h-24 px-3 py-2 rounded-lg border border-input bg-background focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary resize-none"
            />
          </div>

          {/* Difficulty */}
          <div className="space-y-2">
            <Label className="text-foreground font-medium">{t('sequences.difficulty')}</Label>
